...
app.post(
  ...
  authenticateToken,
  async (req: Request, res: Response) => {
    // เปลี่ยนเป็น 'user_img' เพื่อตรงกับ frontend
    try {
...
app.put("/users/:userId/status",authenticateToken,async (req: Request, res: Response) => {
    try {
...
app.put("/users/:userId/roles",authenticateToken,async (req: Request, res: Response) => {
    try {
